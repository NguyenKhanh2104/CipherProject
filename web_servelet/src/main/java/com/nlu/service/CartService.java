...
public class CartService {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ca.findProductById(1));
    }
//    CartItem(id=0, productId=2, name=Ultrabost, img=/main/images/Adidas Ultra Boost.png, price=5000000.0, salesPercent=0.0, productDetailsId=1, size=41, quality=1, product=null)
//CartItem(id=0, productId=1, name=Jordan 1 Retro, img=/main/images/Jordan1-Retro.jpg, price=5000000.0, salesPercent=0.0, productDetailsId=2, size=37, quality=1, product=null)
}
